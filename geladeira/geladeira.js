...
// FUNCIONAMENTO GELADEIRA  >>> 'Meu script'

//document.getElementById('minhaGeladeira').src='fridge.png'
...
function abrir() {
    ...
    if ( document.getElementById('minhaGeladeira').src='fridge.png') { //  quando o usuário clicar no botão "abrir", aparecerá a funçaõ "prompt"
        var escolha_comida = prompt("O que você deseja comer? "); // Pergunta ao usuário o que ele gostaria de comer
        if (alimentos.indexOf(escolha_comida) > -1) { // verifica se a comida escolhida está no estoque da geladeira
